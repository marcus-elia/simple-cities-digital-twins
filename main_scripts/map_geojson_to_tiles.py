...
def main():
    ...
    polygon_category_group.add_argument("--farmland", action='store_true', help='The geojson polygons are farm fields (landuse=farmland in osm)')
    ...
    if args.road:
        ...
        output_filename = FARMLAND_FILENAME
    elif args.runway:
